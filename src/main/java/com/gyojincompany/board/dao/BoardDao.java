...
//		return boardDtos;
	...
	public BoardDto view(String cid) {
		...
		BoardDto boardDto = template.queryForObject(sql, new BeanPropertyRowMapper(BoardDto.class));
...
//		return boardDto;
	...
	public void modify(final String btitle, final String bcontent, final String bid) {
